...
numPlotsIFCCAA <- function(wdir,id) {
  ...
  comunidades <- function(datos) {
    ...
    datos$CCAA  <-  with( datos, case_when(
                                   Origen=="4" |Origen=="11"|Origen=="14"|Origen=="18"|Origen=="21"|Origen=="23"|Origen=="29"|Origen=="41"                           ~ "Andalucía",
                                   Origen=="22"|Origen=="44"|Origen=="50"                                                                                            ~ "Aragón",
                                   Origen=="33"                                                                                                                      ~ "Asturias",
                                   Origen=="7"                                                                                                                       ~ "Baleares",
                                   Origen=="35"|Origen=="38"                                                                                                         ~ "Canarias",
                                   Origen=="39"                                                                                                                      ~ "Cantabria",
                                   Origen=="5" |Origen=="9" |Origen=="24"|Origen=="34"|Origen=="37"|Origen=="23"|Origen=="40"|Origen=="42"|Origen=="47"|Origen=="49" ~ "Cast-León",
                                   Origen=="4" |Origen=="2" | Origen=="13"| Origen=="16"| Origen=="19"| Origen=="45"                                                 ~ "Cast-La Mancha",
                                   Origen=="8" |Origen=="17" | Origen=="25"| Origen=="43"                                                                            ~ "Cataluña",
                                   Origen=="3" |Origen=="12" | Origen=="46"                                                                                          ~ "C. Valenciana",
                                   Origen=="6" |Origen=="10"                                                                                                         ~ "Extremadura",
                                   Origen=="15"|Origen=="27"|Origen=="32"|Origen=="36"                                                                               ~ "Galicia",
                                   Origen=="28"                                                                                                                      ~ "Madrid",
                                   Origen=="30"                                                                                                                      ~ "Murcia",
                                   Origen=="31"                                                                                                                      ~ "Navarra",
                                   Origen=="1" |Origen=="48"|Origen=="20"                                                                                            ~ "Pais Vasco",
                                   Origen=="26"                                                                                                                      ~ "La Rioja" ))
    return(datos)
  }
...
### Representación
####################################IFN2########################################
datosCCAA2 <- numPlotsIFCCAA(wdir=folder,2); ## datosCCAA2
####################################IFN3########################################
datosCCAA3 <- numPlotsIFCCAA(wdir=folder,3); ## datosCCAA3
####################################IFN4########################################
datosCCAA4 <- numPlotsIFCCAA(wdir=folder,4); ## datosCCAA4
###########################BARRAS MULTIPLES#####################################
...
PlotCoord$PlotID <- with(PlotCoord, paste0(Provincia,".",Estadillo))
...
## shape all Europe
shp_0 <- get_eurostat_geospatial(resolution = 10, nuts_level = 2, # big regions
                                 year = 2021, crs = 4326) # WGS84
