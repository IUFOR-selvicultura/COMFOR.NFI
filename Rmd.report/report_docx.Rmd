...
combi<-rbind(combiIFN2_100,combiIFN3_100,combiIFN4_40)
combi$IFN<-c(rep('IFN2',dim(combiIFN2_100)[1]),rep('IFN3',dim(combiIFN3_100)[1]),rep('IFN4',dim(combiIFN4_40)[1]))
...
numPlotsIFCCAA<-function(setwd,id){
  ...
  comunidades<-function(datos){
    ...
    ## datos$CCAA<-with(datos,ifelse(Origen=="4" |Origen=="11"|Origen=="14"|Origen=="18"|Origen=="21"|Origen=="23"|Origen=="29"|Origen=="41","Andalucía",""))
    ## datos$CCAA<-with(datos,ifelse(Origen=="22"|Origen=="44"|Origen=="50", "Aragón", CCAA))
    ...
    ## datos$CCAA<-with(datos,ifelse(Origen=="5" |Origen=="9" |Origen=="24"|Origen=="34"|Origen=="37"|Origen=="23"|Origen=="40"|Origen=="42"|Origen=="47"|Origen=="49", "Cast-León", CCAA))
    ## datos$CCAA<-with(datos,ifelse(Origen=="4" |Origen=="2" | Origen=="13"| Origen=="16"| Origen=="19"| Origen=="45", "Cast-La Mancha", CCAA))
    ## datos$CCAA<-with(datos,ifelse(Origen=="8" |Origen=="17" | Origen=="25"| Origen=="43", "Cataluña", CCAA))
    ## datos$CCAA<-with(datos,ifelse(Origen=="3" |Origen=="12" | Origen=="46", "C. Valenciana", CCAA))
    ...
    ## datos$CCAA<-with(datos,ifelse(Origen=="1" |Origen=="48"|Origen=="20", "Pais Vasco", CCAA))
    ## datos$CCAA<-with(datos,ifelse(Origen=="26","La Rioja",CCAA))
...
```{r provincias en la comunidad autónoma}
