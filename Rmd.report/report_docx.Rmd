...
graficoIndividual <- function(datos,IFN){
  ggplot(data=datos, aes( y=Freq, x=Var1 )) + #coord_fixed(ratio=.040) +
    ...
    theme_grey()+ theme(aspect.ratio=3/4)+
...
ggplot(combi,aes(x=Var1,y=Freq,fill=factor(IFN)))+coord_fixed(ratio=.03) +
  ...
  labs(title = "Combinaciones más frecuentes",
       ...
       y = "Repeticiones",
       fill="IFN") +
  theme_minimal()+theme(aspect.ratio=3/4.5)+
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
## Mapas para cada CCAA

```{r IFN}

parcelas2<-prepararDatos(2)
parcelas3<-prepararDatos(3)
parcelas4<-prepararDatos(4)
...
# Andalucia
                                        # Andalucia
provincias<-unlist(cProvinciasCCAA[1]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[1]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Aragon  
provincias<-unlist(cProvinciasCCAA[2]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[2]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Asturias
provincias<-unlist(cProvinciasCCAA[3]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[3]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Baleares
# provincias<-unlist(cProvinciasCCAA[4]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
                                        # Baleares
# provincias<-unlist(cProvinciasCCAA[4]); datCCAA<-CCAA(provincias, parcelas3);  representacionMapa(datCCAA)

                                        # Canarias
provincias<-unlist(cProvinciasCCAA[5]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[5]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Cantabria     
provincias<-unlist(cProvinciasCCAA[6]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[6]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[6]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Cast-León 
provincias<-unlist(cProvinciasCCAA[7]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[7]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[7]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Cast-La Mancha
provincias<-unlist(cProvinciasCCAA[8]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)
provincias<-unlist(cProvinciasCCAA[8]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)
## provincias<-unlist(cProvinciasCCAA[8]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Cataluña
provincias<-unlist(cProvinciasCCAA[9]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # C. Valenciana
provincias<-unlist(cProvinciasCCAA[10]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # Extremadura
provincias<-unlist(cProvinciasCCAA[11]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # Galicia
provincias<-unlist(cProvinciasCCAA[12]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # Madrid
provincias<-unlist(cProvinciasCCAA[13]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # Murcia 
provincias<-unlist(cProvinciasCCAA[14]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # Navarra
provincias<-unlist(cProvinciasCCAA[15]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # País Vasco
provincias<-unlist(cProvinciasCCAA[16]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)

                                        # La Rioja 
provincias<-unlist(cProvinciasCCAA[17]); datCCAA<-CCAA(provincias, parcelas2); representacionMapa(datCCAA)


                                        # Cataluña
provincias<-unlist(cProvinciasCCAA[9]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # C. Valenciana
provincias<-unlist(cProvinciasCCAA[10]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Extremadura
provincias<-unlist(cProvinciasCCAA[11]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Galicia
provincias<-unlist(cProvinciasCCAA[12]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Madrid
provincias<-unlist(cProvinciasCCAA[13]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Murcia 
provincias<-unlist(cProvinciasCCAA[14]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # Navarra
provincias<-unlist(cProvinciasCCAA[15]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # País Vasco
provincias<-unlist(cProvinciasCCAA[16]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)

                                        # La Rioja 
provincias<-unlist(cProvinciasCCAA[17]); datCCAA<-CCAA(provincias, parcelas3); representacionMapa(datCCAA)


                                        # 1 Andalucia
## provincias<-unlist(cProvinciasCCAA[1]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # 2 Aragon  
## provincias<-unlist(cProvinciasCCAA[2]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # 3 Asturias
provincias<-unlist(cProvinciasCCAA[3]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # 4 Baleares
provincias<-unlist(cProvinciasCCAA[4]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # 5 Canarias
provincias<-unlist(cProvinciasCCAA[5]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)
...
## provincias<-unlist(cProvinciasCCAA[8]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)
                                        ...
                                        # 9 Cataluña
provincias<-unlist(cProvinciasCCAA[9]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # 10 C. Valenciana
## provincias<-unlist(cProvinciasCCAA[10]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Extremadura
provincias<-unlist(cProvinciasCCAA[11]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Galicia
provincias<-unlist(cProvinciasCCAA[12]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Madrid
provincias<-unlist(cProvinciasCCAA[13]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Murcia 
provincias<-unlist(cProvinciasCCAA[14]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # Navarra
provincias<-unlist(cProvinciasCCAA[15]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # País Vasco
provincias<-unlist(cProvinciasCCAA[16]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)

                                        # La Rioja 
## provincias<-unlist(cProvinciasCCAA[17]); datCCAA<-CCAA(provincias, parcelas4); representacionMapa(datCCAA)
