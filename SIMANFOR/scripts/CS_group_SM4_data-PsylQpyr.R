...
# set directory
general_dir <- "/media/aitor/Elements1/aitor/iuFOR_trabajo/Repositorios/LINUX/simanfor-dask/simulator/output/COMFOR_SUDOE/PsylQpyr/"
setwd(general_dir)
...
write.csv(plots, '/media/aitor/Elements1/aitor/iuFOR_trabajo/Proyectos/COMFOR_SUDOE/SIMANFOR_deliverable/results/all_results_PsylQpyr.csv')
